        ...
        >
            ...
            >
                ...
                <div className="relative z-10 p-3.5 pl-4 sm:p-4 sm:pl-5 flex items-start gap-2.5 sm:gap-3">
                    ...
                    >
                        <PremiumIcon type={item.icon as ArsenalIconType} size="md" className={cn(config.color, 'transition-transform duration-300')} />
                    </div>
    ...
    return (
        ...
        >
            <svg className="w-20 h-20 md:w-24 md:h-24" viewBox="0 0 100 100" fill="none">
                ...
                <path d="M50 15 L54 42 L50 38 L46 42 Z" fill="url(#compassGradientC)" />
    ...
    return (
        ...
        >
            <svg className="w-12 h-12 md:w-14 md:h-14" viewBox="0 0 50 50" fill="none">
                <path d="M12 12 L38 38 M38 12 L12 38" stroke="url(#xGradientC)" strokeWidth="4" strokeLinecap="round" />
                <circle cx="25" cy="25" r="20" stroke="url(#xGradientC)" strokeWidth="1" strokeDasharray="4 4" opacity="0.4" fill="none" />
                <defs>
                    <linearGradient id="xGradientC" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="#6eff5b" />
        ...
        <section ref={sectionRef} className="relative z-10 py-14 sm:py-16 md:py-28 lg:py-32 px-5 sm:px-6 overflow-hidden">
            <div className="relative max-w-6xl mx-auto">
                ...
                >
                    ...
                    {/* Title - MAIOR (de text-lg/xl/2xl/3xl para text-xl/2xl/3xl/4xl) */}
                    <h2 className="max-w-4xl mx-auto text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-tight mb-4">
                        {title.split('produtos e conteúdos').map((part, index, array) => {
                            ...
                            return (
                                <span key={index}>
                                    {part}
                                    <span className="text-transparent bg-clip-text bg-linear-to-r from-brand-400 to-brand-300">produtos</span>
                                    {' e '}
                                    <span className="text-transparent bg-clip-text bg-linear-to-r from-accent-400 to-accent-300">conteúdos</span>
                                </span>
                            );
                        })}
                    </h2>
                    {/* Description - MAIOR */}
                    <p className="text-brand-400 text-lg md:text-xl font-medium">
                        {description}
                    </p>
                </motion.div>
                ...
                {/* Note Box - Textos MAIORES (de text-base/lg para text-lg/xl) */}
                {note && (
                    <motion.div
                        ...
                        <div className="group relative p-5 sm:p-6 md:p-10 rounded-2xl sm:rounded-3xl bg-linear-to-br from-gold-500/10 via-gold-400/5 to-transparent backdrop-blur-sm border border-gold-400/30 hover:border-gold-400/50 transition-all duration-500 shadow-lg shadow-gold-500/10 hover:shadow-lg hover:shadow-gold-500/15 hover:scale-[1.01]">
                            ...
                            <div className="flex justify-center mb-8">
                                <motion.div
                                    ...
                                    className="relative"
                                >
                                    <Sparkles className="w-8 h-8 md:w-10 md:h-10 text-gold-400 drop-shadow-[0_0_4px_rgba(251,191,36,0.2)]" strokeWidth={1} />
                                </motion.div>
                            </div>

                            <div className="space-y-6 text-center px-2 md:px-4 pb-4">
                                {/* Primeiro parágrafo - MAIS MAIOR */}
                                <p className="text-cream-200 text-xl md:text-2xl leading-relaxed font-medium">
