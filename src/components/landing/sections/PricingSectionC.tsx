...
interface PricingSectionCProps {
    title: string;
    description: string;
    pricing: Pricing;
}

export function PricingSectionC({ title, description, pricing }: PricingSectionCProps) {
        ...
        <section className="relative py-16 sm:py-20 md:py-24 px-5 sm:px-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-12 sm:mb-16 md:mb-20">
                    ...
                    {description && (
                        <div className="flex justify-center mt-2 ml-[380px]">
