...
export function HowWeDefeatSectionD({
    ...
    return (
        ...
        >
            {/* Animated orbs - DISABLED on mobile to improve performance */}
            {!isMobile && (
            ...
            <div className="relative max-w-4xl mx-auto z-10">
                ...
                <div className="relative mb-6 flex justify-center items-center">
                    {isMobile ? (
                        // Static Brain Icon for Mobile - Zero Animations
                    ...
                    {/* Partículas brancas - desktop only */}
