...
import { HowWeDefeatSectionC } from './sections/HowWeDefeatSectionC';
import { PricingSectionC } from './sections/PricingSectionC';

export function LandingC() {
    const { hero, sections, pricing } = landingCContent;
