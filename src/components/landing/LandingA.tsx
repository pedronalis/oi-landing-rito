...
export function LandingA() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      {/* Premium gradient background orbs with parallax */}
      ...
      {/* Hero Section - Premium with staggered animations */}
      <section className="relative z-10 pt-2 pb-6 md:pt-4 md:pb-12 lg:pt-6 lg:pb-20 px-5 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          <StaggerContainer staggerDelay={0.15} className="space-y-8">
            ...
            {/* Subtitle */}
            <StaggerItem>
              <p className="text-sm md:text-base lg:text-lg text-cream-400 max-w-2xl mx-auto leading-relaxed">
                {hero.subtitle}
              </p>
            </StaggerItem>
      ...
      {/* Platform Section - Journey Cards */}
          ...
          <section className="relative z-10 py-14 sm:py-16 md:py-28 lg:py-32 px-5 sm:px-6">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              <ScrollReveal withScale>
                ...
                {/* Title with particle suction effect */}
      ...
      {/* Arsenal Section - Treasure Map Design */}
      ...
      {/* Comparison Section - Premium Visual Design */}
      ...
      {sections.find((s) => s.type === 'experiences') && (() => {
        ...
        const experienceConfig = [
          {
            image: '/uploads/focusblocus_card.webp',
            colorVariant: 'brand' as const,
          },
          {
            image: '/uploads/slowflow_card.webp',
            colorVariant: 'accent' as const,
          },
          {
            image: '/uploads/oraculo_card.webp',
            colorVariant: 'brand' as const,
          },
          {
            image: '/uploads/quests_card.webp',
            colorVariant: 'accent' as const,
          },
        ];
        ...
        return (
          <section className="relative z-10 py-14 sm:py-16 md:py-28 lg:py-36 px-5 sm:px-6">
            <div className="relative z-10 max-w-6xl mx-auto">
              ...
              {/* Grid 4 colunas com cards verticais */}
          ...
          <section className="relative z-10 py-14 sm:py-16 md:py-28 lg:py-32 px-5 sm:px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6 lg:gap-8 mb-12">
                ...
                {/* Ordem side - Premium Highlighted Card */}
                <ScrollReveal delay={0.2}>
                  <div
                    className={cn(
                      'relative h-full rounded-2xl',
      ...
      {/* Guarantee Section - Premium Refactored */}
